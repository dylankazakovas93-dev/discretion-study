...
def graph_candidate_row(c) -> dict:
    ...
    return {
        ...
        "target_anchor_timeframe": c.target_anchor_timeframe,
        "target_surface_policy": c.target_surface_policy,
        "target_prominence_grade": c.target_prominence_grade,
        "selected_target_rank": c.selected_target_rank,
        "selection_rule_id": c.selection_rule_id,
        "natural_target": s.structural_target, "executed_target": s.executed_target,
